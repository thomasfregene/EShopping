...
namespace EShopping.Identity
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiResource> ApiResources =>
            new ApiResource[]
            {
                //List of Microservice resources
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client
               {
                   ...
                   ClientSecrets = {new Secret("5c6ec4c4-61a7-4668-ac57-2b4591ec26d2".Sha256()) },
                   AllowedGrantTypes = GrantTypes.ClientCredentials,
                 ...
                 new Client
               {
                   ...
                   ClientSecrets = {new Secret("5c6ef5f5-61a7-4668-ac57-2b4591ec26d2".Sha256()) },
                   AllowedGrantTypes = GrantTypes.ClientCredentials,
